...
API_CATALOG: Dict[str, Any] = {
    ...
    "UC Registered Models": {
        ...
        "endpoints": [
            # ── Registered Models ─────────────────────────────────────────
            {
                ...
                "description": "Creates a new UC-registered model in the specified catalog and schema.",
                "params": [],
            ...
            },
            {
                ...
                "method": "GET",
                "path": "/api/2.1/unity-catalog/models",
                "description": "Lists UC-registered models. Filter by catalog_name and/or schema_name to scope the results.",
                "params": [
                    _p("catalog_name", "Parent catalog of the models. Required when schema_name is supplied."),
                    _p("schema_name", "Parent schema of the models."),
                    _p("max_results", "Maximum number of models to return.", type_=INT),
                    _p("page_token", "Pagination token from a previous list call."),
                ],
                "body": None,
            },
            {
                ...
                "method": "GET",
                "path": "/api/2.1/unity-catalog/models/{full_name}",
                "description": "Gets a UC-registered model by its full three-level name (catalog.schema.model).",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("include_aliases", "Include alias info in the response (true/false).", default="true", type_=BOOL),
                    _p("include_browse", "Include browse-only models the caller has metadata access to.", type_=BOOL),
                ],
                "path_params": ["full_name"],
                "body": None,
            },
            {
                ...
                "method": "PATCH",
                "path": "/api/2.1/unity-catalog/models/{full_name}",
                "description": "Updates the metadata of a UC-registered model (e.g. comment, owner, new name).",
                "params": [_p("full_name", "Full name of the model: catalog.schema.model", required=True)],
                "path_params": ["full_name"],
                "body": '{\n  "comment": "<new_comment>"\n}',
            },
            {
                ...
                "method": "DELETE",
                "path": "/api/2.1/unity-catalog/models/{full_name}",
                "description": "Deletes a UC-registered model and all of its versions.",
                "params": [_p("full_name", "Full name of the model: catalog.schema.model", required=True)],
                "path_params": ["full_name"],
                "body": None,
            },
            # ── Model Versions ────────────────────────────────────────────
            {
                "id": "uc-model-versions-list",
                "name": "List Model Versions",
                "method": "GET",
                "path": "/api/2.1/unity-catalog/models/{full_name}/versions",
                "description": "Lists all versions of a UC-registered model.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("max_results", "Maximum number of versions to return.", type_=INT),
                    _p("page_token", "Pagination token from a previous list call."),
                ],
                "path_params": ["full_name"],
                "body": None,
            ...
            {
                "id": "uc-model-versions-get",
                "name": "Get Model Version",
                "method": "GET",
                "path": "/api/2.1/unity-catalog/models/{full_name}/versions/{version}",
                "description": "Gets a specific version of a UC-registered model.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("version", "Model version number.", required=True, type_=INT),
                    _p("include_aliases", "Include alias info in the response (true/false).", default="true", type_=BOOL),
                    _p("include_browse", "Include the version when the caller only has metadata access.", type_=BOOL),
                ],
                "path_params": ["full_name", "version"],
                "body": None,
            },
            {
                "id": "uc-model-versions-update",
                "name": "Update Model Version",
                "method": "PATCH",
                "path": "/api/2.1/unity-catalog/models/{full_name}/versions/{version}",
                "description": "Updates a specific version of a UC-registered model (e.g. comment).",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("version", "Model version number.", required=True, type_=INT),
                ],
            ...
            {
                "id": "uc-model-versions-delete",
                "name": "Delete Model Version",
                "method": "DELETE",
                "path": "/api/2.1/unity-catalog/models/{full_name}/versions/{version}",
                "description": "Deletes a specific version of a UC-registered model.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("version", "Model version number.", required=True, type_=INT),
                ],
            ...
            {
                "id": "uc-model-versions-get-by-alias",
                "name": "Get Model Version by Alias",
                "method": "GET",
                "path": "/api/2.1/unity-catalog/models/{full_name}/aliases/{alias}",
                "description": "Returns the model version pointed to by an alias.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("alias", "The alias name (e.g. 'champion', 'production').", required=True),
                ],
                "path_params": ["full_name", "alias"],
                "body": None,
            },
            # ── Aliases ───────────────────────────────────────────────────
            {
                "id": "uc-model-aliases-set",
                "name": "Set Model Version Alias",
                "method": "PUT",
                "path": "/api/2.1/unity-catalog/models/{full_name}/aliases/{alias}",
                "description": "Sets an alias on a model version. Aliases replace stages from the legacy registry.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("alias", "The alias name (e.g. 'champion', 'production').", required=True),
                ],
            ...
            {
                "id": "uc-model-aliases-delete",
                "name": "Delete Model Version Alias",
                "method": "DELETE",
                "path": "/api/2.1/unity-catalog/models/{full_name}/aliases/{alias}",
                "description": "Deletes an alias from a model. Does not delete the underlying model version.",
                "params": [
                    _p("full_name", "Full name of the model: catalog.schema.model", required=True),
                    _p("alias", "The alias name to delete.", required=True),
                ],
                "path_params": ["full_name", "alias"],
                "body": None,
            },
    ...
    "Model Registry": {
        ...
        "endpoints": [
            # ── Registered Models ─────────────────────────────────────────
            {
                "id": "mlflow-registered-models-create",
                "name": "Create Registered Model",
                "method": "POST",
                "path": "/api/2.0/mlflow/registered-models/create",
                "description": "Creates a new registered model with the given name. Returns the new RegisteredModel object.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "tags": [],\n  "description": ""\n}',
            },
            {
                "id": "mlflow-registered-models-get",
                "name": "Get Registered Model",
                "method": "GET",
                "path": "/api/2.0/mlflow/registered-models/get",
                "description": "Returns the registered model with the given name. Includes latest versions per stage.",
                "params": [_p("name", "The registered model unique name identifier.", required=True)],
                "body": None,
            },
            {
                "id": "mlflow-registered-models-rename",
            ...
            {
                "id": "mlflow-registered-models-update",
                "name": "Update Registered Model",
                "method": "PATCH",
                "path": "/api/2.0/mlflow/registered-models/update",
                "description": "Updates the description for a registered model.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "description": "<new_description>"\n}',
            },
            {
                "id": "mlflow-registered-models-delete",
                "name": "Delete Registered Model",
                "method": "DELETE",
                "path": "/api/2.0/mlflow/registered-models/delete",
                "description": "Deletes a registered model and all of its versions.",
                "params": [_p("name", "The registered model unique name identifier.", required=True)],
                "body": None,
            },
            {
                ...
                "params": [
                    ...
                    _p("filter", "String filter condition for models (e.g. name LIKE 'fraud%')."),
                    _p("order_by", "Columns for ordering results."),
                    _p("page_token", "Pagination token from a previous search call."),
                ],
                "body": None,
            },
            {
                "id": "mlflow-registered-models-get-latest-versions",
                "name": "Get Latest Model Versions",
                "method": "POST",
                "path": "/api/2.0/mlflow/registered-models/get-latest-versions",
                "description": "Returns the latest model version for each stage (or all stages if omitted).",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "stages": ["Production", "Staging"]\n}',
            },
            {
                "id": "mlflow-registered-models-set-tag",
                "name": "Set Registered Model Tag",
                "method": "POST",
                "path": "/api/2.0/mlflow/registered-models/set-tag",
                "description": "Sets a tag on a registered model. Creates the tag if it does not exist.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "key": "<tag_key>",\n  "value": "<tag_value>"\n}',
            },
            {
                "id": "mlflow-registered-models-delete-tag",
                ...
                "params": [
                    _p("name", "The registered model unique name identifier.", required=True),
                    _p("key", "The tag key to delete.", required=True),
                ],
                "body": None,
            },
            # ── Model Versions ────────────────────────────────────────────
            {
                "id": "mlflow-model-versions-create",
                "name": "Create Model Version",
                "method": "POST",
                "path": "/api/2.0/mlflow/model-versions/create",
                "description": "Creates a new model version for a registered model.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "source": "dbfs:/path/to/model",\n  "run_id": "<run_id>",\n  "description": "",\n  "tags": []\n}',
            },
            {
                "id": "mlflow-model-versions-get",
                "name": "Get Model Version",
                "method": "GET",
                "path": "/api/2.0/mlflow/model-versions/get",
                "description": "Returns a single model version specified by name and version.",
                "params": [
                    _p("name", "The registered model name.", required=True),
                    _p("version", "Model version number.", required=True),
                ],
                "body": None,
            },
            {
                "id": "mlflow-model-versions-update",
                "name": "Update Model Version",
                "method": "PATCH",
                "path": "/api/2.0/mlflow/model-versions/update",
                "description": "Updates the description for a model version.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "description": "<new_description>"\n}',
            },
            {
                "id": "mlflow-model-versions-delete",
                "name": "Delete Model Version",
                "method": "DELETE",
            ...
            {
                "id": "mlflow-model-versions-search",
                "name": "Search Model Versions",
                "method": "GET",
                "path": "/api/2.0/mlflow/model-versions/search",
                "description": "Searches for model versions. Databricks requires the filter to specify at least one of name, run_id, or source — e.g. name='my_model'.",
                "params": [
                    _p("filter", "Filter expression. Must include name, run_id, or source — e.g. name='my_model' or run_id='<run_id>'.", required=True),
                    _p("max_results", "Max number of model versions to return.", type_=INT),
                    _p("order_by", "Order by clause, e.g. 'version_number DESC'."),
                    _p("page_token", "Pagination token from a previous search call."),
                ],
                "body": None,
            },
            {
                "id": "mlflow-model-versions-get-download-uri",
                "name": "Get Model Version Download URI",
                "method": "GET",
                "path": "/api/2.0/mlflow/model-versions/get-download-uri",
                "description": "Gets a URI to download the artifacts of a model version.",
                "params": [
                    _p("name", "The registered model name.", required=True),
                    _p("version", "Model version number.", required=True),
                ],
            ...
            {
                "id": "mlflow-model-versions-transition-stage",
                "name": "Transition Model Version Stage",
                "method": "POST",
                "path": "/api/2.0/mlflow/model-versions/transition-stage",
                "description": "Transitions a model version to a new stage (None, Staging, Production, Archived). Deprecated for UC-registered models — use aliases instead.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "stage": "Production",\n  "archive_existing_versions": false,\n  "comment": ""\n}',
            },
            {
                "id": "mlflow-model-versions-set-tag",
                "name": "Set Model Version Tag",
                "method": "POST",
                "path": "/api/2.0/mlflow/model-versions/set-tag",
                "description": "Sets a tag on a model version.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "key": "<tag_key>",\n  "value": "<tag_value>"\n}',
            },
            {
                "id": "mlflow-model-versions-delete-tag",
                "name": "Delete Model Version Tag",
                "method": "DELETE",
                "path": "/api/2.0/mlflow/model-versions/delete-tag",
                "description": "Deletes a tag from a model version.",
                "params": [
                    _p("name", "The registered model name.", required=True),
                    _p("version", "Model version number.", required=True),
                    _p("key", "The tag key to delete.", required=True),
            ...
            # ── Comments (Databricks workspace registry only) ─────────────
            {
                "id": "mlflow-comments-create",
                "name": "Create Comment",
                "method": "POST",
                "path": "/api/2.0/mlflow/comments/create",
                "description": "Posts a comment on a model version. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "comment": "<comment_text>"\n}',
            },
            {
                "id": "mlflow-comments-update",
                "name": "Update Comment",
                "method": "PATCH",
                "path": "/api/2.0/mlflow/comments/update",
                "description": "Updates an existing comment on a model version. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "id": "<comment_id>",\n  "comment": "<new_comment_text>"\n}',
            },
            {
                "id": "mlflow-comments-delete",
                "name": "Delete Comment",
                "method": "DELETE",
                "path": "/api/2.0/mlflow/comments/delete",
                "description": "Deletes a comment on a model version. Databricks workspace model registry only.",
                "params": [_p("id", "The unique comment ID.", required=True)],
                "body": None,
            },
            # ── Transition Requests (Databricks workspace registry only) ──
            {
                "id": "mlflow-transition-requests-create",
                "name": "Create Transition Request",
                "method": "POST",
                "path": "/api/2.0/mlflow/transition-requests/create",
                "description": "Requests transitioning a model version to a new stage. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "stage": "Production",\n  "comment": ""\n}',
            },
            {
                "id": "mlflow-transition-requests-list",
                "name": "List Transition Requests",
                "method": "GET",
                "path": "/api/2.0/mlflow/transition-requests/list",
                "description": "Lists open stage transition requests for a model version. Databricks workspace model registry only.",
                "params": [
                    _p("name", "The registered model name.", required=True),
                    _p("version", "Model version number.", required=True),
                ],
            ...
            {
                "id": "mlflow-transition-requests-approve",
                "name": "Approve Transition Request",
                "method": "POST",
                "path": "/api/2.0/mlflow/transition-requests/approve",
                "description": "Approves a stage transition request. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "stage": "Production",\n  "archive_existing_versions": false,\n  "comment": ""\n}',
            },
            {
                "id": "mlflow-transition-requests-reject",
                "name": "Reject Transition Request",
                "method": "POST",
                "path": "/api/2.0/mlflow/transition-requests/reject",
                "description": "Rejects a stage transition request. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "name": "<model_name>",\n  "version": "<version_number>",\n  "stage": "Production",\n  "comment": ""\n}',
            },
            {
                "id": "mlflow-transition-requests-delete",
                "name": "Delete Transition Request",
                "method": "DELETE",
                "path": "/api/2.0/mlflow/transition-requests/delete",
                "description": "Cancels an open stage transition request. Databricks workspace model registry only.",
                "params": [
                    _p("name", "The registered model name.", required=True),
                    _p("version", "Model version number.", required=True),
                    _p("stage", "Target stage of the request being cancelled.", required=True),
                    _p("creator", "Username of the request creator.", required=True),
                ],
                "body": None,
            },
            # ── Registry Webhooks (Databricks workspace registry only) ────
            {
                "id": "mlflow-registry-webhooks-create",
                "name": "Create Registry Webhook",
                "method": "POST",
                "path": "/api/2.0/mlflow/registry-webhooks/create",
                "description": "Creates a registry webhook that fires on model registry events. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "model_name": "<model_name>",\n  "events": ["MODEL_VERSION_CREATED"],\n  "description": "",\n  "status": "ACTIVE",\n  "http_url_spec": {\n    "url": "https://example.com/webhook",\n    "secret": "",\n    "authorization": "Bearer <token>"\n  }\n}',
            },
            {
                "id": "mlflow-registry-webhooks-list",
                "name": "List Registry Webhooks",
                "method": "GET",
                "path": "/api/2.0/mlflow/registry-webhooks/list",
                "description": "Lists registry webhooks, optionally filtered by model name and events. Databricks workspace model registry only.",
                "params": [
                    _p("model_name", "Optional model name filter."),
                    _p("events", "Optional comma-separated events filter."),
                    _p("page_token", "Pagination token from a previous list call."),
                ],
                "body": None,
            },
            {
                "id": "mlflow-registry-webhooks-update",
                "name": "Update Registry Webhook",
                "method": "PATCH",
                "path": "/api/2.0/mlflow/registry-webhooks/update",
                "description": "Updates an existing registry webhook. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "id": "<webhook_id>",\n  "events": ["MODEL_VERSION_CREATED"],\n  "description": "",\n  "status": "ACTIVE"\n}',
            },
            {
                "id": "mlflow-registry-webhooks-test",
                "name": "Test Registry Webhook",
                "method": "POST",
                "path": "/api/2.0/mlflow/registry-webhooks/test",
                "description": "Sends a test event to a registry webhook to verify it is configured correctly. Databricks workspace model registry only.",
                "params": [],
                "body": '{\n  "id": "<webhook_id>",\n  "event": "MODEL_VERSION_CREATED"\n}',
            },
            {
                "id": "mlflow-registry-webhooks-delete",
                "name": "Delete Registry Webhook",
                "method": "DELETE",
                "path": "/api/2.0/mlflow/registry-webhooks/delete",
                "description": "Deletes a registry webhook. Databricks workspace model registry only.",
                "params": [_p("id", "The webhook ID.", required=True)],
                "body": None,
            },
        ],
    },
    ...
    "Model Serving": {
        ...
        "endpoints": [
            ...
            {
                "id": "serving-endpoints-create-pt",
                "name": "Create PT Endpoint",
                "method": "POST",
                "path": "/api/2.0/serving-endpoints/pt",
                "description": "Creates a new provisioned throughput (PT) serving endpoint. Public preview.",
                "params": [],
                "body": '{\n  "name": "<pt_endpoint_name>",\n  "config": {\n    "served_entities": [\n      {\n        "name": "my-entity",\n        "entity_name": "main.default.my_model",\n        "entity_version": "1"\n      }\n    ]\n  }\n}',
            },
            {
                "id": "serving-endpoints-delete",
                "name": "Delete Endpoint",
                "method": "DELETE",
                "path": "/api/2.0/serving-endpoints/{name}",
                "description": "Deletes a serving endpoint and all associated data.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                "id": "serving-endpoints-update-config",
                "name": "Update Endpoint Config",
                "method": "PUT",
                "path": "/api/2.0/serving-endpoints/{name}/config",
                "description": "Updates served entities, compute configuration, and traffic routing for a serving endpoint.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "served_entities": [\n    {\n      "entity_name": "main.default.my_model",\n      "entity_version": "2",\n      "workload_size": "Small",\n      "scale_to_zero_enabled": true\n    }\n  ]\n}',
            },
            {
                "id": "serving-endpoints-update-pt-config",
                "name": "Update PT Endpoint Config",
                "method": "PUT",
                "path": "/api/2.0/serving-endpoints/pt/{name}/config",
                "description": "Updates the config of a provisioned throughput serving endpoint. Public preview.",
                "params": [_p("name", "The name of the PT serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "config": {\n    "served_entities": [\n      {\n        "name": "my-entity",\n        "entity_name": "main.default.my_model",\n        "entity_version": "2"\n      }\n    ]\n  }\n}',
            },
            {
                "id": "serving-endpoints-config-start",
                "name": "Start Endpoint",
                "method": "POST",
                "path": "/api/2.0/serving-endpoints/{name}/config:start",
                "description": "Starts a stopped serving endpoint by creating a new config version with the same properties.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": "{}",
            },
            {
                "id": "serving-endpoints-config-stop",
                "name": "Stop Endpoint",
                "method": "POST",
                "path": "/api/2.0/serving-endpoints/{name}/config:stop",
                "description": "Stops a serving endpoint so it no longer accepts traffic.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": "{}",
            },
            {
                "id": "serving-endpoints-update-ai-gateway",
                "name": "Update AI Gateway",
                "method": "PUT",
                "path": "/api/2.0/serving-endpoints/{name}/ai-gateway",
                "description": "Updates the AI Gateway configuration (rate limits, guardrails, inference tables, usage tracking).",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "rate_limits": [\n    {\n      "calls_per_minute": 60,\n      "key": "user"\n    }\n  ]\n}',
            },
            {
                "id": "serving-endpoints-update-notifications",
                "name": "Update Notifications",
                "method": "PATCH",
                "path": "/api/2.0/serving-endpoints/{name}/notifications",
                "description": "Updates email notification settings for endpoint state changes.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "email_notifications": {\n    "on_update_success": ["user@example.com"]\n  }\n}',
            },
            {
                "id": "serving-endpoints-patch-tags",
                "name": "Patch Endpoint Tags",
                "method": "PATCH",
                "path": "/api/2.0/serving-endpoints/{name}/tags",
                "description": "Batch add and delete tags on a serving endpoint.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "add_tags": [\n    {"key": "env", "value": "dev"}\n  ],\n  "delete_tags": []\n}',
            },
            {
                "id": "serving-endpoints-put-rate-limits",
                "name": "Put Rate Limits",
                "method": "PUT",
                "path": "/api/2.0/serving-endpoints/{name}/rate-limits",
                "description": "Updates endpoint rate limits. Deprecated — prefer AI Gateway rate limits.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "rate_limits": [\n    {\n      "calls_per_minute": 60,\n      "key": "user"\n    }\n  ]\n}',
            },
            {
                "id": "serving-endpoints-query",
                "name": "Query Endpoint",
                "method": "POST",
                "path": "/api/2.0/serving-endpoints/{name}/invocations",
                "description": "Queries a serving endpoint with tensor, dataframe, or chat/completions payloads.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "dataframe_records": [\n    {"feature_a": 1.0, "feature_b": "value"}\n  ]\n}',
            },
            {
                "id": "serving-endpoints-get-openapi",
                "name": "Get OpenAPI Schema",
                "method": "GET",
                "path": "/api/2.0/serving-endpoints/{name}/openapi",
                "description": "Returns the query schema of the serving endpoint in OpenAPI format.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                "id": "serving-endpoints-export-metrics",
                "name": "Export Metrics",
                "method": "GET",
                "path": "/api/2.0/serving-endpoints/{name}/metrics",
                "description": "Retrieves serving endpoint metrics in Prometheus or OpenMetrics format.",
                "params": [_p("name", "The name of the serving endpoint.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                "id": "serving-endpoints-build-logs",
                "name": "Get Build Logs",
                "method": "GET",
                "path": "/api/2.0/serving-endpoints/{name}/served-models/{served_model_name}/build-logs",
                "description": "Retrieves build logs for a served model on the endpoint.",
                "params": [
                    _p("name", "The name of the serving endpoint.", required=True),
                    _p("served_model_name", "The name of the served model.", required=True),
                ],
                "path_params": ["name", "served_model_name"],
                "body": None,
            },
            {
                "id": "serving-endpoints-logs",
                "name": "Get Server Logs",
                "method": "GET",
                "path": "/api/2.0/serving-endpoints/{name}/served-models/{served_model_name}/logs",
                "description": "Retrieves service logs for a served model on the endpoint.",
                "params": [
                    _p("name", "The name of the serving endpoint.", required=True),
                    _p("served_model_name", "The name of the served model.", required=True),
                ],
            ...
            {
                "id": "serving-endpoints-permission-levels",
                "name": "Get Permission Levels",
                "method": "GET",
                "path": "/api/2.0/permissions/serving-endpoints/{serving_endpoint_id}/permissionLevels",
                "description": "Gets the permission levels that can be assigned on a serving endpoint.",
                "params": [_p("serving_endpoint_id", "The serving endpoint ID.", required=True)],
                "path_params": ["serving_endpoint_id"],
                "body": None,
            },
            {
                "id": "serving-endpoints-permissions-get",
                "name": "Get Permissions",
                "method": "GET",
                "path": "/api/2.0/permissions/serving-endpoints/{serving_endpoint_id}",
                "description": "Gets the permissions of a serving endpoint.",
                "params": [_p("serving_endpoint_id", "The serving endpoint ID.", required=True)],
                "path_params": ["serving_endpoint_id"],
                "body": None,
            },
            {
                "id": "serving-endpoints-permissions-set",
                "name": "Set Permissions",
                "method": "PUT",
                "path": "/api/2.0/permissions/serving-endpoints/{serving_endpoint_id}",
                "description": "Sets permissions on a serving endpoint, replacing existing permissions.",
                "params": [_p("serving_endpoint_id", "The serving endpoint ID.", required=True)],
                "path_params": ["serving_endpoint_id"],
                "body": '{\n  "access_control_list": [\n    {\n      "user_name": "user@example.com",\n      "permission_level": "CAN_QUERY"\n    }\n  ]\n}',
            },
            {
                "id": "serving-endpoints-permissions-update",
                "name": "Update Permissions",
                "method": "PATCH",
                "path": "/api/2.0/permissions/serving-endpoints/{serving_endpoint_id}",
                "description": "Updates permissions on a serving endpoint.",
                "params": [_p("serving_endpoint_id", "The serving endpoint ID.", required=True)],
                "path_params": ["serving_endpoint_id"],
    ...
    "Vector Search Endpoints": {
        ...
        "endpoints": [
            ...
            },
            {
                ...
                "name": "Get Endpoint",
                "method": "GET",
                "path": "/api/2.0/vector-search/endpoints/{endpoint_name}",
                "description": "Get details for a single Vector Search endpoint.",
                "params": [_p("endpoint_name", "Name of the endpoint.", required=True)],
                "path_params": ["endpoint_name"],
                "body": None,
            },
            {
                "id": "vs-endpoints-create",
                "name": "Create Endpoint",
                "method": "POST",
                "path": "/api/2.0/vector-search/endpoints",
            ...
            {
                "id": "vs-endpoints-patch",
                "name": "Update Endpoint",
                "method": "PATCH",
                "path": "/api/2.0/vector-search/endpoints/{endpoint_name}",
                "description": "Update endpoint scaling (Public preview).",
                "params": [_p("endpoint_name", "Name of the endpoint.", required=True)],
                "path_params": ["endpoint_name"],
                "body": '{\n  "target_qps": 100\n}',
            },
            {
                "id": "vs-endpoints-patch-budget-policy",
                "name": "Update Budget Policy",
                "method": "PATCH",
                "path": "/api/2.0/vector-search/endpoints/{endpoint_name}/budget-policy",
                "description": "Update the budget policy of an endpoint (Public preview).",
                "params": [_p("endpoint_name", "Name of the endpoint.", required=True)],
                "path_params": ["endpoint_name"],
                "body": '{\n  "budget_policy_id": "8b0444ff-8b60-48b0-9d31-e391f6126e0f"\n}',
            },
            {
                "id": "vs-endpoints-metrics",
                "name": "Retrieve Metrics",
                "method": "POST",
                "path": "/api/2.0/vector-search/endpoints/{endpoint_name}/metrics",
                "description": "Retrieve user-visible metrics for an endpoint.",
                "params": [_p("endpoint_name", "Name of the endpoint.", required=True)],
                "path_params": ["endpoint_name"],
                "body": '{\n  "start_time": "2024-01-01T00:00:00Z",\n  "end_time": "2024-01-02T00:00:00Z",\n  "granularity_in_seconds": 60,\n  "metrics": [\n    {\n      "name": "query_qps"\n    }\n  ]\n}',
            },
            {
                "id": "vs-endpoints-permission-levels",
                "name": "Get Permission Levels",
                "method": "GET",
                "path": "/api/2.0/permissions/vector-search-endpoints/{endpoint_id}/permissionLevels",
                "description": "Gets permission levels assignable on a Vector Search endpoint.",
                "params": [_p("endpoint_id", "Endpoint UUID (from list/get response id field).", required=True)],
                "path_params": ["endpoint_id"],
                "body": None,
            },
            {
                "id": "vs-endpoints-permissions-get",
                "name": "Get Permissions",
                "method": "GET",
                "path": "/api/2.0/permissions/vector-search-endpoints/{endpoint_id}",
                "description": "Gets permissions on a Vector Search endpoint.",
                "params": [_p("endpoint_id", "Endpoint UUID (from list/get response id field).", required=True)],
                "path_params": ["endpoint_id"],
                "body": None,
            },
            {
                "id": "vs-endpoints-permissions-set",
                "name": "Set Permissions",
                "method": "PUT",
                "path": "/api/2.0/permissions/vector-search-endpoints/{endpoint_id}",
                "description": "Sets permissions on a Vector Search endpoint, replacing existing permissions.",
                "params": [_p("endpoint_id", "Endpoint UUID (from list/get response id field).", required=True)],
                "path_params": ["endpoint_id"],
                "body": '{\n  "access_control_list": [\n    {\n      "user_name": "user@example.com",\n      "permission_level": "CAN_QUERY"\n    }\n  ]\n}',
            },
            {
                "id": "vs-endpoints-permissions-update",
                "name": "Update Permissions",
                "method": "PATCH",
                "path": "/api/2.0/permissions/vector-search-endpoints/{endpoint_id}",
                "description": "Updates permissions on a Vector Search endpoint.",
                "params": [_p("endpoint_id", "Endpoint UUID (from list/get response id field).", required=True)],
                "path_params": ["endpoint_id"],
                "body": '{\n  "access_control_list": [\n    {\n      "user_name": "user@example.com",\n      "permission_level": "CAN_MANAGE"\n    }\n  ]\n}',
            },
        ...
        "endpoints": [
            {
                ...
                "description": "List indexes on a Vector Search endpoint. Leave endpoint_name blank to fan out across ALL endpoints in this workspace.",
                "params": [
                    _p("endpoint_name", "Name of the Vector Search endpoint. Leave blank to list indexes across all endpoints."),
                    _p("page_token", "Pagination token."),
                ],
                "body": None,
            },
            {
                ...
                "name": "Get Index",
                "method": "GET",
                "path": "/api/2.0/vector-search/indexes/{index_name}",
                "description": "Get details for a Vector Search index.",
                "params": [
                    _p("index_name", "Name of the index.", required=True),
                    _p("compatible_with_reranker", "Return a reranker-compatible index URL.", type_="boolean"),
                ],
                "path_params": ["index_name"],
                "body": None,
            },
            {
                "id": "vs-indexes-create",
                "name": "Create Index",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes",
                "description": "Create a Delta Sync or Direct Access Vector Search index.",
                "params": [],
            ...
            {
                "id": "vs-indexes-delete",
                "name": "Delete Index",
                "method": "DELETE",
                "path": "/api/2.0/vector-search/indexes/{index_name}",
                "description": "Delete a Vector Search index.",
                "params": [_p("index_name", "Name of the index.", required=True)],
                "path_params": ["index_name"],
                "body": None,
            },
            {
                ...
                "name": "Sync Index",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes/{index_name}/sync",
            ...
            },
            {
                ...
                "name": "Query Index",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes/{index_name}/query",
                "description": "Query a Vector Search index (ANN, hybrid, or full-text).",
                "params": [_p("index_name", "Name of the index.", required=True)],
                "path_params": ["index_name"],
                "body": '{\n  "columns": ["id", "text"],\n  "query_text": "Databricks AI Search",\n  "num_results": 10\n}',
            },
            {
                "id": "vs-indexes-query-next-page",
                "name": "Query Next Page",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes/{index_name}/query-next-page",
                "description": "Fetch the next page of query results using next_page_token from a prior query.",
                "params": [_p("index_name", "Name of the index.", required=True)],
                "path_params": ["index_name"],
            ...
            },
            {
                ...
                "name": "Scan Index",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes/{index_name}/scan",
                "description": "Scan a Direct Access index, returning entries after an optional primary key cursor.",
                "params": [_p("index_name", "Name of the index.", required=True)],
                "path_params": ["index_name"],
                "body": '{\n  "num_results": 10\n}',
            },
            {
                "id": "vs-indexes-upsert-data",
                "name": "Upsert Data",
                "method": "POST",
                "path": "/api/2.0/vector-search/indexes/{index_name}/upsert-data",
                "description": "Upsert rows into a Direct Access index.",
                "params": [_p("index_name", "Name of the index.", required=True)],
                "path_params": ["index_name"],
                "body": '{\n  "inputs_json": "[{\\"id\\": \\"1\\", \\"text\\": \\"hello world\\", \\"text_vector\\": [1.0, 2.0, 3.0]}]"\n}',
            },
            {
                "id": "vs-indexes-delete-data",
                "name": "Delete Data",
                "method": "DELETE",
                "path": "/api/2.0/vector-search/indexes/{index_name}/delete-data",
                "description": "Delete rows from a Direct Access index by primary key.",
                "params": [
                    _p("index_name", "Name of the index.", required=True),
                    _p("primary_keys", "Comma-separated primary keys to delete.", required=True),
                ],
                "path_params": ["index_name"],
                "body": None,
            },
    ...
    "AI Search Endpoints": {
        ...
        "endpoints": [
            {
                "id": "aisearch-endpoints-list",
                "name": "List Endpoints",
                "method": "GET",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints",
                "description": "List AI Search endpoints in a workspace. AIP-conformant replacement for the legacy Vector Search Endpoints API. workspace_id is auto-filled from the active connection.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("page_size", "Best-effort upper bound on results.", type_=INT),
                    _p("page_token", "Pagination token from a previous response."),
                ],
                "path_params": ["workspace_id"],
                "body": None,
            },
            {
                "id": "aisearch-endpoints-get",
                "name": "Get Endpoint",
                "method": "GET",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}",
                "description": "Get details for a single AI Search endpoint.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint.", required=True),
                ],
                "path_params": ["workspace_id", "endpoint_id"],
                "body": None,
            },
            {
                "id": "aisearch-endpoints-create",
                "name": "Create Endpoint",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints",
                "description": "Create a new AI Search endpoint. The short name is supplied via the endpoint_id query parameter; endpoint_type is required and immutable.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "User-supplied short name for the endpoint.", required=True),
                ],
                "path_params": ["workspace_id"],
                "body": '{\n  "endpoint_type": "STANDARD"\n}',
            },
            {
                "id": "aisearch-endpoints-update",
                "name": "Update Endpoint",
                "method": "PATCH",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}",
                "description": "Update an AI Search endpoint. update_mask lists the fields to change (e.g. budget_policy_id, custom_tags, target_qps, replica_count).",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint.", required=True),
                    _p("update_mask", "Comma-separated list of fields to update (e.g. target_qps).", required=True),
                ],
                "path_params": ["workspace_id", "endpoint_id"],
                "body": '{\n  "target_qps": 100\n}',
            },
            {
                "id": "aisearch-endpoints-delete",
                "name": "Delete Endpoint",
                "method": "DELETE",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}",
                "description": "Delete an AI Search endpoint.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint.", required=True),
                ],
    ...
    "AI Search Indexes": {
        ...
        "endpoints": [
            {
                "id": "aisearch-indexes-list",
                "name": "List Indexes",
                "method": "GET",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes",
                "description": "List AI Search indexes hosted on an endpoint.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the indexes.", required=True),
                    _p("page_size", "Best-effort upper bound on results.", type_=INT),
                    _p("page_token", "Pagination token from a previous response."),
                ],
                "path_params": ["workspace_id", "endpoint_id"],
            ...
            {
                "id": "aisearch-indexes-get",
                "name": "Get Index",
                "method": "GET",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}",
                "description": "Get details for a single AI Search index.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
                ],
                "path_params": ["workspace_id", "endpoint_id", "index_id"],
                "body": None,
            },
            {
                "id": "aisearch-indexes-create",
                "name": "Create Index",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes",
                "description": "Create a Delta Sync or Direct Access AI Search index. The UC table name is supplied via the index_id query parameter.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint that will host the index.", required=True),
                    _p("index_id", "Unity Catalog table name for the index (catalog.schema.name).", required=True),
                ],
                "path_params": ["workspace_id", "endpoint_id"],
                "body": '{\n  "primary_key": "id",\n  "index_type": "DELTA_SYNC",\n  "delta_sync_index_spec": {\n    "source_table": "main.docs.en_wiki",\n    "pipeline_type": "TRIGGERED",\n    "columns_to_sync": ["id", "text"],\n    "embedding_source_columns": [\n      {\n        "name": "text",\n        "embedding_model_endpoint": "databricks-gte-large-en"\n      }\n    ]\n  }\n}',
            },
            {
                "id": "aisearch-indexes-delete",
                "name": "Delete Index",
                "method": "DELETE",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}",
                "description": "Delete an AI Search index.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
            ...
            {
                "id": "aisearch-indexes-query",
                "name": "Query Index",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}:query",
                "description": "Query (search) an AI Search index (ANN, HYBRID, or FULL_TEXT). Read-only, so a read-scoped token may invoke it.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
            ...
            {
                "id": "aisearch-indexes-scan",
                "name": "Scan Index",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}:scan",
                "description": "Scan (paginate over) the rows of an AI Search index.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
            ...
            {
                "id": "aisearch-indexes-sync",
                "name": "Sync Index",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}:sync",
                "description": "Synchronize a Delta Sync index with its source Delta table. Applies only to Delta Sync indexes.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
            ...
            {
                "id": "aisearch-indexes-upsert-data",
                "name": "Upsert Data",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}:upsertData",
                "description": "Upsert rows into a Direct Access AI Search index.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
            ...
            {
                "id": "aisearch-indexes-remove-data",
                "name": "Remove Data",
                "method": "POST",
                "path": "/api/2.0/ai-search/workspaces/{workspace_id}/endpoints/{endpoint_id}/indexes/{index_id}:removeData",
                "description": "Remove rows by primary key from a Direct Access AI Search index.",
                "params": [
                    _p("workspace_id", "Numeric workspace ID (auto-filled from the connection).", required=True),
                    _p("endpoint_id", "Short name of the endpoint hosting the index.", required=True),
                    _p("index_id", "Unity Catalog table name of the index (catalog.schema.name).", required=True),
        ...
        "endpoints": [
            {
                ...
                "params": [
                    _p("page_size", "Upper bound for items returned.", type_=INT),
                    _p("page_token", "Pagination token for the next page."),
                    _p("space", "Filter apps by app space name."),
                ],
                "body": None,
            },
            {
                ...
                "name": "Get App",
                "method": "GET",
                "path": "/api/2.0/apps/{name}",
                "description": "Retrieves information for the app with the supplied name.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                ...
                "params": [
                    _p("no_compute", "If true, the app will not be started after creation.", type_=BOOL),
                ],
            ...
            {
                "id": "apps-create-update",
                "name": "Create App Update",
                "method": "POST",
                "path": "/api/2.0/apps/{name}/update",
                "description": "Creates an app update and starts the asynchronous update process. Check status with Get App Update.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
            ...
            },
            {
                ...
                "method": "GET",
                "path": "/api/2.0/apps/{name}/update",
                "description": "Gets the status of an in-progress or completed app update.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                ...
                "method": "DELETE",
                "path": "/api/2.0/apps/{name}",
                "description": "Deletes an app and all associated data.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": None,
            },
            {
                ...
                "name": "Deploy App",
                "method": "POST",
                "path": "/api/2.0/apps/{name}/deployments",
                "description": "Creates a new deployment for the app.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": '{\n  "source_code_path": "/Workspace/Users/<user>/my-app",\n  "mode": "SNAPSHOT"\n}',
            },
            {
                "id": "apps-list-deployments",
                "name": "List Deployments",
                "method": "GET",
                "path": "/api/2.0/apps/{name}/deployments",
                "description": "Lists all deployments for the app.",
                "params": [
                    _p("name", "The name of the app.", required=True),
                    _p("page_size", "Upper bound for items returned.", type_=INT),
                    _p("page_token", "Pagination token for the next page."),
                ],
                "path_params": ["name"],
            ...
            {
                "id": "apps-get-deployment",
                "name": "Get Deployment",
                "method": "GET",
                "path": "/api/2.0/apps/{name}/deployments/{deployment_id}",
                "description": "Retrieves information for a specific app deployment.",
                "params": [
                    _p("name", "The name of the app.", required=True),
                    _p("deployment_id", "The unique ID of the deployment.", required=True),
                ],
                "path_params": ["name", "deployment_id"],
                "body": None,
            },
            {
                "id": "apps-start",
                "name": "Start App",
                "method": "POST",
                "path": "/api/2.0/apps/{name}/start",
                "description": "Starts the last active deployment of the app.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": "{}",
            },
            {
                ...
                "name": "Stop App",
                "method": "POST",
                "path": "/api/2.0/apps/{name}/stop",
                "description": "Stops the active deployment of the app.",
                "params": [_p("name", "The name of the app.", required=True)],
                "path_params": ["name"],
                "body": "{}",
            },
            {
                ...
                "name": "Get App Logs",
                "method": "GET",
                "path": "/api/2.0/apps/{name}/deployments/logs",
                "description": "Retrieves stdout/stderr logs for the app's active deployment.",
                "params": [
                    _p("name", "The name of the app.", required=True),
                    _p("tail_lines", "Number of recent log lines to return (0 = all).", type_=INT),
                    _p("search", "Search term to filter logs server-side."),
                    _p("source", "Restrict logs to APP or SYSTEM."),
                    _p("page_token", "Pagination token for additional log pages."),
                ],
                "path_params": ["name"],
                "body": None,
            },
            {
                "id": "apps-permission-levels",
                "name": "Get Permission Levels",
                "method": "GET",
                "path": "/api/2.0/permissions/apps/{app_name}/permissionLevels",
                "description": "Gets the permission levels that can be assigned on an app.",
                "params": [_p("app_name", "The name of the app.", required=True)],
                "path_params": ["app_name"],
                "body": None,
            },
            {
                "id": "apps-permissions-get",
                "name": "Get Permissions",
                "method": "GET",
                "path": "/api/2.0/permissions/apps/{app_name}",
                "description": "Gets the permissions of an app.",
                "params": [_p("app_name", "The name of the app.", required=True)],
                "path_params": ["app_name"],
                "body": None,
            },
            {
                "id": "apps-permissions-set",
                "name": "Set Permissions",
                "method": "PUT",
                "path": "/api/2.0/permissions/apps/{app_name}",
                "description": "Sets permissions on an app, replacing existing permissions.",
                "params": [_p("app_name", "The name of the app.", required=True)],
                "path_params": ["app_name"],
                "body": '{\n  "access_control_list": [\n    {\n      "user_name": "user@example.com",\n      "permission_level": "CAN_USE"\n    }\n  ]\n}',
            },
            {
                "id": "apps-permissions-update",
                "name": "Update Permissions",
                "method": "PATCH",
                "path": "/api/2.0/permissions/apps/{app_name}",
                "description": "Updates permissions on an app.",
                "params": [_p("app_name", "The name of the app.", required=True)],
                "path_params": ["app_name"],
                "body": '{\n  "access_control_list": [\n    {\n      "user_name": "user@example.com",\n      "permission_level": "CAN_MANAGE"\n    }\n  ]\n}',
            },
        ...
        "endpoints": [
            ...
            # ── Users ──────────────────────────────────────────────
            {
                ...
                "params": [
                    ...
                    _p("attributes", "Comma-separated list of attributes to return."),
                    _p("excludedAttributes", "Comma-separated list of attributes to exclude."),
                    _p("sortBy", "Attribute to sort results by."),
                    _p("sortOrder", "Sort order: ascending or descending."),
                ],
                "body": None,
            },
            {
                ...
                "name": "Get User",
                "method": "GET",
                "path": "/api/2.0/preview/scim/v2/Users/{id}",
                "description": "Gets details for a single user by SCIM ID.",
                "params": [_p("id", "SCIM ID of the user.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
            {
                ...
                "method": "POST",
                "path": "/api/2.0/preview/scim/v2/Users",
                "description": "Creates a new user in the workspace. The user must already exist in the account.",
                "params": [],
            ...
            },
            {
                ...
                "method": "PUT",
                "path": "/api/2.0/preview/scim/v2/Users/{id}",
                "description": "Replaces a user's information with the provided resource (full overwrite).",
                "params": [_p("id", "SCIM ID of the user.", required=True)],
                "path_params": ["id"],
            ...
            },
            {
                ...
                "method": "PATCH",
                "path": "/api/2.0/preview/scim/v2/Users/{id}",
                "description": "Partially updates a user with SCIM PatchOp operations.",
                "params": [_p("id", "SCIM ID of the user.", required=True)],
                "path_params": ["id"],
            ...
            },
            {
                ...
                "method": "DELETE",
                "path": "/api/2.0/preview/scim/v2/Users/{id}",
                "description": "Deactivates a user by SCIM ID. The user is removed from the workspace but may remain in the account.",
                "params": [_p("id", "SCIM ID of the user.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
            ...
            },
            {
                ...
                "name": "Get Group",
                "method": "GET",
                "path": "/api/2.0/preview/scim/v2/Groups/{id}",
                "description": "Gets details for a single group by SCIM ID.",
                "params": [_p("id", "SCIM ID of the group.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
            {
            ...
            {
                "id": "scim-groups-update",
                "name": "Replace Group",
                "method": "PUT",
                "path": "/api/2.0/preview/scim/v2/Groups/{id}",
                "description": "Replaces a group's information with the provided resource (full overwrite).",
                "params": [_p("id", "SCIM ID of the group.", required=True)],
                "path_params": ["id"],
                "body": '{\n  "schemas": ["urn:ietf:params:scim:schemas:core:2.0:Group"],\n  "displayName": "my-group",\n  "members": []\n}',
            },
            {
                ...
                "method": "PATCH",
                "path": "/api/2.0/preview/scim/v2/Groups/{id}",
                "description": "Partially updates a group with SCIM PatchOp operations (e.g. add or remove members).",
                "params": [_p("id", "SCIM ID of the group.", required=True)],
                "path_params": ["id"],
                "body": '{\n  "schemas": ["urn:ietf:params:scim:api:messages:2.0:PatchOp"],\n  "Operations": [\n    {\n      "op": "add",\n      "path": "members",\n      "value": [\n        {\n          "value": "<user-scim-id>"\n        }\n      ]\n    }\n  ]\n}',
            },
            {
                ...
                "method": "DELETE",
                "path": "/api/2.0/preview/scim/v2/Groups/{id}",
                "description": "Deletes a group by SCIM ID.",
                "params": [_p("id", "SCIM ID of the group.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
            ...
            {
                "id": "scim-service-principals-get",
                "name": "Get Service Principal",
                "method": "GET",
                "path": "/api/2.0/preview/scim/v2/ServicePrincipals/{id}",
                "description": "Gets details for a single service principal by SCIM ID.",
                "params": [_p("id", "SCIM ID of the service principal.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
            {
                "id": "scim-service-principals-create",
                "name": "Create Service Principal",
                "method": "POST",
                "path": "/api/2.0/preview/scim/v2/ServicePrincipals",
                "description": "Creates a new service principal in the workspace.",
                "params": [],
                "body": '{\n  "schemas": ["urn:ietf:params:scim:schemas:core:2.0:ServicePrincipal"],\n  "displayName": "my-service-principal",\n  "active": true\n}',
            },
            {
                "id": "scim-service-principals-update",
                "name": "Replace Service Principal",
                "method": "PUT",
                "path": "/api/2.0/preview/scim/v2/ServicePrincipals/{id}",
                "description": "Replaces a service principal's information with the provided resource (full overwrite).",
                "params": [_p("id", "SCIM ID of the service principal.", required=True)],
                "path_params": ["id"],
                "body": '{\n  "schemas": ["urn:ietf:params:scim:schemas:core:2.0:ServicePrincipal"],\n  "displayName": "my-service-principal",\n  "active": true\n}',
            },
            {
                "id": "scim-service-principals-patch",
                "name": "Update Service Principal (PATCH)",
                "method": "PATCH",
                "path": "/api/2.0/preview/scim/v2/ServicePrincipals/{id}",
                "description": "Partially updates a service principal with SCIM PatchOp operations.",
                "params": [_p("id", "SCIM ID of the service principal.", required=True)],
                "path_params": ["id"],
                "body": '{\n  "schemas": ["urn:ietf:params:scim:api:messages:2.0:PatchOp"],\n  "Operations": [\n    {\n      "op": "replace",\n      "path": "active",\n      "value": false\n    }\n  ]\n}',
            },
            {
                "id": "scim-service-principals-delete",
                "name": "Delete Service Principal",
                "method": "DELETE",
                "path": "/api/2.0/preview/scim/v2/ServicePrincipals/{id}",
                "description": "Deletes a service principal by SCIM ID.",
                "params": [_p("id", "SCIM ID of the service principal.", required=True)],
                "path_params": ["id"],
                "body": None,
            },
    ...
    "Access Control": {
        ...
        "endpoints": [
            {
                "id": "acc-proxy-assignable-roles",
                "name": "Get Assignable Roles for Resource",
                "method": "GET",
                "path": "/api/2.0/preview/accounts/access-control/assignable-roles",
                "description": "Gets all the roles that can be granted on an account-level resource. A role is grantable if the rule set on the resource can contain an access rule of that role.",
                "preview": True,
                "params": [
                    _p("resource", "The resource name for which assignable roles are listed, e.g. accounts/<account_id>.", required=True),
                ],
                "body": None,
            },
            {
                "id": "acc-proxy-rule-set-get",
                "name": "Get Rule Set",
                "method": "GET",
                "path": "/api/2.0/preview/accounts/access-control/rule-sets",
                "description": "Gets a rule set by its name. A rule set defines the role-based access-control rules bound to an account or workspace resource.",
                "preview": True,
                "params": [
                    _p("name", "The rule set name, e.g. accounts/<account_id>/ruleSets/default.", required=True),
                    _p("etag", "Etag for optimistic concurrency (from a prior get/update).", required=True),
                ],
                "body": None,
            },
            {
                "id": "acc-proxy-rule-set-update",
                "name": "Update Rule Set",
                "method": "PUT",
                "path": "/api/2.0/preview/accounts/access-control/rule-sets",
                "description": "Replaces the rules of a rule set. First get the current rule set to obtain its etag, then submit the full desired rule set.",
                "preview": True,
                "params": [],
                "body": '{\n  "name": "accounts/<account_id>/ruleSets/default",\n  "rule_set": {\n    "name": "accounts/<account_id>/ruleSets/default",\n    "grant_rules": [\n      {\n        "principals": ["groups/admins"],\n        "role": "roles/marketplace.admin"\n      }\n    ],\n    "etag": "<etag-from-get>"\n  }\n}',
            },
            {
                "id": "permission-migration",
                "name": "Migrate Permissions",
                "method": "POST",
                "path": "/api/2.0/permissionmigration",
                "description": "Migrates acl permissions from a legacy workspace-local group to an account group. Used primarily by the UCX migration tool.",
                "params": [],
                "body": '{\n  "workspace_id": 123456789,\n  "from_workspace_group_name": "legacy-group",\n  "to_account_group_name": "account-group",\n  "size": 100\n}',
            },
        ],
    },
    "Tokens": {
    ...
    "Permissions": {
        ...
        "endpoints": [
            ...
            {
                "id": "permissions-get",
                "name": "Get Object Permissions",
                "method": "GET",
                "path": "/api/2.0/permissions/{request_object_type}/{request_object_id}",
                "description": "Gets the permissions of an object. Objects can inherit permissions from their parent objects or root object. request_object_type is e.g. clusters, jobs, pipelines, notebooks, directories, experiments, registered-models, serving-endpoints, sql/warehouses, authorization.",
                "params": [
                    _p("request_object_type", "The type of the request object, e.g. clusters, jobs, pipelines.", required=True),
                    _p("request_object_id", "The ID of the request object.", required=True),
                ],
                "path_params": ["request_object_type", "request_object_id"],
                "body": None,
            },
            {
                "id": "permissions-levels-get",
                "name": "Get Object Permission Levels",
                "method": "GET",
                "path": "/api/2.0/permissions/{request_object_type}/{request_object_id}/permissionLevels",
                "description": "Gets the permission levels that a user can have on an object.",
                "params": [
                    _p("request_object_type", "The type of the request object.", required=True),
                    _p("request_object_id", "The ID of the request object.", required=True),
                ],
                "path_params": ["request_object_type", "request_object_id"],
                "body": None,
            ...
            {
                "id": "permissions-set",
                "name": "Set Object Permissions",
                "method": "PUT",
                "path": "/api/2.0/permissions/{request_object_type}/{request_object_id}",
                "description": "Sets permissions on an object, replacing existing permissions if they exist. Deletes all direct permissions if none are specified.",
                "params": [
                    _p("request_object_type", "The type of the request object.", required=True),
                    _p("request_object_id", "The ID of the request object.", required=True),
                ],
            ...
            {
                "id": "permissions-passwords-get",
                "name": "Get Password Permissions",
                "method": "GET",
                "path": "/api/2.0/permissions/authorization/passwords",
                "description": "Gets the workspace-level password (native login) permissions. Controls which groups can use username/password login.",
                "params": [],
                "body": None,
            },
            {
                "id": "permissions-passwords-levels-get",
                "name": "Get Password Permission Levels",
                "method": "GET",
                "path": "/api/2.0/permissions/authorization/passwords/permissionLevels",
                "description": "Gets the permission levels a user can have on the workspace password (native login) object.",
                "params": [],
                "body": None,
            },
            {
                "id": "permissions-passwords-set",
                "name": "Set Password Permissions",
                "method": "PUT",
                "path": "/api/2.0/permissions/authorization/passwords",
                "description": "Sets workspace-level password (native login) permissions, replacing existing ones.",
                "params": [],
                "body": '{\n  "access_control_list": [\n    {\n      "group_name": "users",\n      "permission_level": "CAN_USE"\n    }\n  ]\n}',
            },
            {
                "id": "permissions-passwords-update",
                "name": "Update Password Permissions",
                "method": "PATCH",
                "path": "/api/2.0/permissions/authorization/passwords",
                "description": "Updates the workspace-level password (native login) permissions.",
                "params": [],
                "body": '{\n  "access_control_list": [\n    {\n      "group_name": "users",\n      "permission_level": "CAN_USE"\n    }\n  ]\n}',
            },
        ],
...
# Mark the Model Registry section as legacy — the workspace model registry has
# been superseded by the Unity Catalog model registry (/api/2.1/unity-catalog/models).
API_CATALOG["Model Registry"]["legacy"] = True
...
LIST_TO_GET: Dict[str, Any] = {
    ...
    "mlflow-registered-models-search": ("mlflow-registered-models-get", "registered_models", "name", "name", None, None, [
                                      ...
                                      ("mlflow-model-versions-search", "bi-list-ul", "Search Versions", {"filter": "name"}),
                                  ]),
    "mlflow-model-versions-search": ("mlflow-model-versions-get", "model_versions", "version", "version", "name", {"name": "name"}, [
                                      ("mlflow-model-versions-get-download-uri", "bi-cloud-download", "Get Download URI", {"name": "name", "version": "version"}),
                                      ("mlflow-transition-requests-list", "bi-arrow-left-right", "List Transition Requests", {"name": "name", "version": "version"}),
                                  ]),
    "mlflow-registry-webhooks-list": ("mlflow-registry-webhooks-test", "webhooks", "id", "id", "description", None, [
                                      ("mlflow-registry-webhooks-update", "bi-pencil", "Update Webhook", {"id": "id"}),
                                      ("mlflow-registry-webhooks-delete", "bi-trash", "Delete Webhook", {"id": "id"}),
                                  ]),
    ...
    "scim-users-list":            ("scim-users-get",         "Resources",      "id",            "id",            "displayName", None, [
                                      ("scim-users-patch", "bi-pencil", "Update User (PATCH)", {"id": "id"}),
                                      ("scim-users-delete", "bi-trash", "Delete User", {"id": "id"}),
                                  ]),
    "scim-groups-list":           ("scim-groups-get",        "Resources",      "id",            "id",            "displayName", None, [
                                      ("scim-groups-patch", "bi-pencil", "Update Group (PATCH)", {"id": "id"}),
                                      ("scim-groups-delete", "bi-trash", "Delete Group", {"id": "id"}),
                                  ]),
    "scim-service-principals-list": ("scim-service-principals-get", "Resources", "id",           "id",            "displayName", None, [
                                      ("scim-service-principals-patch", "bi-pencil", "Update Service Principal (PATCH)", {"id": "id"}),
                                      ("scim-service-principals-delete", "bi-trash", "Delete Service Principal", {"id": "id"}),
                                  ]),
    "vs-endpoints-list":          ("vs-endpoints-get",       "endpoints",      "name",          "endpoint_name", None, None, [
                                      ("vs-indexes-list", "bi-list-ul", "List Indexes", {"endpoint_name": "name"}),
                                      ("vs-endpoints-metrics", "bi-graph-up", "Retrieve Metrics", {"endpoint_name": "name"}),
                                      ("vs-endpoints-permissions-get", "bi-shield-check", "Get Permissions", {"endpoint_id": "id"}),
                                  ]),
    "vs-indexes-list":            ("vs-indexes-get",         "vector_indexes", "name",          "index_name",    "name", {"endpoint_name": "endpoint_name"}, [
                                      ("vs-indexes-query", "bi-search", "Query Index", {"index_name": "name"}),
                                      ("vs-indexes-sync", "bi-arrow-repeat", "Sync Index", {"index_name": "name"}),
                                  ]),
    "aisearch-endpoints-list":    ("aisearch-endpoints-get", "endpoints",      "@name",         "endpoint_id",   "name", None, [
                                      ("aisearch-indexes-list", "bi-list-ul", "List Indexes", {"endpoint_id": "@name"}),
                                  ]),
    "aisearch-indexes-list":      ("aisearch-indexes-get",   "indexes",        "@name",         "index_id",      "name", {"endpoint_id": "@@name"}, [
                                      ("aisearch-indexes-query", "bi-search", "Query Index", {"endpoint_id": "@@name", "index_id": "@name"}),
                                      ("aisearch-indexes-sync", "bi-arrow-repeat", "Sync Index", {"endpoint_id": "@@name", "index_id": "@name"}),
                                  ]),
    "apps-list":                  ("apps-get",               "apps",           "name",          "name",          None, None, [
...
ACCOUNT_API_CATALOG: Dict[str, Any] = {
    ...
    "Workspace Assignment": {
        ...
        "endpoints": [
            {
                "id": "acct-workspace-assignment-list",
                "name": "List Permission Assignments",
                "method": "GET",
                "path": "/api/2.0/accounts/{account_id}/workspaces/{workspace_id}/permissionassignments",
                "description": "Gets the permission assignments for the specified workspace. Lists the identities (users, groups, service principals) assigned to the workspace and their permissions.",
                "params": [
                    _p("account_id", "Databricks account ID.", required=True),
                    _p("workspace_id", "Numeric ID of the workspace.", required=True),
                ],
                "body": None,
                "path_params": ["account_id", "workspace_id"],
            },
            {
                "id": "acct-workspace-assignment-get",
                "name": "List Assignable Permissions",
                "method": "GET",
                "path": "/api/2.0/accounts/{account_id}/workspaces/{workspace_id}/permissionassignments/permissions",
                "description": "Gets the set of permissions that a principal can be assigned on the specified workspace (e.g. USER, ADMIN).",
                "params": [
                    _p("account_id", "Databricks account ID.", required=True),
                    _p("workspace_id", "Numeric ID of the workspace.", required=True),
                ],
            ...
            {
                "id": "acct-workspace-assignment-update",
                "name": "Create or Update Assignment",
                "method": "PUT",
                "path": "/api/2.0/accounts/{account_id}/workspaces/{workspace_id}/permissionassignments/principals/{principal_id}",
                "description": "Creates or updates the workspace permissions assignment for a principal (user, group, or service principal).",
                "params": [
                    _p("account_id", "Databricks account ID.", required=True),
                    _p("workspace_id", "Numeric ID of the workspace.", required=True),
                    _p("principal_id", "Databricks internal ID of the principal.", required=True),
                ],
                "path_params": ["account_id", "workspace_id", "principal_id"],
                "body": '{\n  "permissions": ["USER"]\n}',
            },
            {
                "id": "acct-workspace-assignment-delete",
                "name": "Delete Assignment",
                "method": "DELETE",
                "path": "/api/2.0/accounts/{account_id}/workspaces/{workspace_id}/permissionassignments/principals/{principal_id}",
                "description": "Deletes the workspace permissions assignment for a principal, removing them from the workspace.",
                "params": [
                    _p("account_id", "Databricks account ID.", required=True),
                    _p("workspace_id", "Numeric ID of the workspace.", required=True),
                    _p("principal_id", "Databricks internal ID of the principal.", required=True),
        ...
        for category_name, category in catalog.items():
            for endpoint in category["endpoints"]:
                if endpoint["id"] == endpoint_id:
                    return {
                        "preview": category.get("preview", False),
                        **endpoint,
...
CATEGORY_DOCS_MAP: Dict[str, str] = {
    ...
    "UC Registered Models": "workspace/registeredmodels",
    "Model Registry":      "workspace/modelregistry",
    "Experiments Tracing": "workspace/mlflowexperimenttrace",
    "Model Serving":       "workspace/servingendpoints",
    "Vector Search Endpoints": "workspace/vectorsearchendpoints",
    "Vector Search Indexes":   "workspace/vectorsearchindexes",
    "AI Search Endpoints":     "workspace/aisearch",
    "AI Search Indexes":       "workspace/aisearch",
    "Apps":                "workspace/apps",
    "Secrets":             "workspace/secrets",
    "Identity (SCIM)":     "workspace/users",
    "Access Control":      "workspace/accountaccesscontrolproxy",
    ...
    "Workspace Assignment":   "account/workspaceassignment",
...
DOCS_URL_MAP: Dict[str, str] = {
    ...
    # Workspace — UC Registered Models (modern UC model registry)
    "uc-models-create":                       "workspace/registeredmodels/create",
    "uc-models-list":                         "workspace/registeredmodels/list",
    "uc-models-get":                          "workspace/registeredmodels/get",
    "uc-models-update":                       "workspace/registeredmodels/update",
    "uc-models-delete":                       "workspace/registeredmodels/delete",
    "uc-model-versions-list":                 "workspace/modelversions/list",
    "uc-model-versions-get":                  "workspace/modelversions/get",
    "uc-model-versions-update":               "workspace/modelversions/update",
    "uc-model-versions-delete":               "workspace/modelversions/delete",
    "uc-model-versions-get-by-alias":         "workspace/modelversions/getbyalias",
    "uc-model-aliases-set":                   "workspace/registeredmodels/setregisteredmodelalias",
    "uc-model-aliases-delete":                "workspace/registeredmodels/deleteregisteredmodelalias",
    # Workspace — Model Registry
    "mlflow-registered-models-create":              "workspace/modelregistry/createmodel",
    "mlflow-registered-models-get":                 "workspace/modelregistry/getmodel",
    "mlflow-registered-models-rename":              "workspace/modelregistry/renamemodel",
    "mlflow-registered-models-update":              "workspace/modelregistry/updatemodel",
    "mlflow-registered-models-delete":              "workspace/modelregistry/deletemodel",
    "mlflow-registered-models-search":              "workspace/modelregistry/searchregisteredmodels",
    "mlflow-registered-models-get-latest-versions": "workspace/modelregistry/getlatestmodelversions",
    "mlflow-registered-models-set-tag":             "workspace/modelregistry/setregisteredmodeltag",
    "mlflow-registered-models-delete-tag":          "workspace/modelregistry/deleteregisteredmodeltag",
    "mlflow-model-versions-create":                 "workspace/modelregistry/createmodelversion",
    "mlflow-model-versions-get":                    "workspace/modelregistry/getmodelversion",
    "mlflow-model-versions-update":                 "workspace/modelregistry/updatemodelversion",
    "mlflow-model-versions-delete":                 "workspace/modelregistry/deletemodelversion",
    "mlflow-model-versions-search":                 "workspace/modelregistry/searchmodelversions",
    "mlflow-model-versions-get-download-uri":       "workspace/modelregistry/getmodelversiondownloaduri",
    "mlflow-model-versions-transition-stage":       "workspace/modelregistry/transitionstage",
    "mlflow-model-versions-set-tag":                "workspace/modelregistry/setmodelversiontag",
    "mlflow-model-versions-delete-tag":             "workspace/modelregistry/deletemodelversiontag",
    "mlflow-comments-create":                       "workspace/modelregistry/createcomment",
    "mlflow-comments-update":                       "workspace/modelregistry/updatecomment",
    "mlflow-comments-delete":                       "workspace/modelregistry/deletecomment",
    "mlflow-transition-requests-create":            "workspace/modelregistry/createtransitionrequest",
    "mlflow-transition-requests-list":              "workspace/modelregistry/listtransitionrequests",
    "mlflow-transition-requests-approve":           "workspace/modelregistry/approvetransitionrequest",
    "mlflow-transition-requests-reject":            "workspace/modelregistry/rejecttransitionrequest",
    "mlflow-transition-requests-delete":            "workspace/modelregistry/deletetransitionrequest",
    "mlflow-registry-webhooks-create":              "workspace/modelregistry/createregistrywebhook",
    "mlflow-registry-webhooks-list":                "workspace/modelregistry/listregistrywebhooks",
    "mlflow-registry-webhooks-update":              "workspace/modelregistry/updateregistrywebhook",
    "mlflow-registry-webhooks-test":                "workspace/modelregistry/testregistrywebhook",
    "mlflow-registry-webhooks-delete":              "workspace/modelregistry/deleteregistrywebhook",
    ...
    "serving-endpoints-create":               "workspace/servingendpoints/create",
    "serving-endpoints-create-pt":            "workspace/servingendpoints/createprovisionedthroughputendpoint",
    "serving-endpoints-delete":               "workspace/servingendpoints/delete",
    "serving-endpoints-update-config":        "workspace/servingendpoints/updateconfig",
    "serving-endpoints-update-pt-config":     "workspace/servingendpoints/updateprovisionedthroughputendpointconfig",
    "serving-endpoints-config-start":         "workspace/servingendpoints/configstart",
    "serving-endpoints-config-stop":          "workspace/servingendpoints/configstop",
    "serving-endpoints-update-ai-gateway":    "workspace/servingendpoints/updateaigateway",
    "serving-endpoints-update-notifications": "workspace/servingendpoints/updatenotifications",
    "serving-endpoints-patch-tags":           "workspace/servingendpoints/patchtags",
    "serving-endpoints-put-rate-limits":      "workspace/servingendpoints/putratelimits",
    "serving-endpoints-query":                "workspace/servingendpoints/invocations",
    "serving-endpoints-get-openapi":          "workspace/servingendpoints/getopenapi",
    "serving-endpoints-export-metrics":       "workspace/servingendpoints/exportmetrics",
    "serving-endpoints-build-logs":           "workspace/servingendpoints/getbuildlogs",
    "serving-endpoints-logs":                 "workspace/servingendpoints/getlogs",
    "serving-endpoints-permission-levels":    "workspace/servingendpoints/getpermissionlevels",
    "serving-endpoints-permissions-get":      "workspace/servingendpoints/getpermissions",
    "serving-endpoints-permissions-set":      "workspace/servingendpoints/setpermissions",
    "serving-endpoints-permissions-update":   "workspace/servingendpoints/updatepermissions",
    # Workspace — Vector Search Endpoints
    "vs-endpoints-list":                      "workspace/vectorsearchendpoints/listendpoints",
    "vs-endpoints-get":                       "workspace/vectorsearchendpoints/getendpoint",
    "vs-endpoints-create":                    "workspace/vectorsearchendpoints/createendpoint",
    "vs-endpoints-delete":                    "workspace/vectorsearchendpoints/deleteendpoint",
    "vs-endpoints-patch":                     "workspace/vectorsearchendpoints/patchendpoint",
    "vs-endpoints-patch-budget-policy":       "workspace/vectorsearchendpoints/updateendpointbudgetpolicy",
    "vs-endpoints-metrics":                   "workspace/vectorsearchendpoints/retrieveuservisiblemetrics",
    "vs-endpoints-permission-levels":         "workspace/vectorsearchendpoints/getpermissionlevels",
    "vs-endpoints-permissions-get":           "workspace/vectorsearchendpoints/getpermissions",
    "vs-endpoints-permissions-set":           "workspace/vectorsearchendpoints/setpermissions",
    "vs-endpoints-permissions-update":        "workspace/vectorsearchendpoints/updatepermissions",
    # Workspace — Vector Search Indexes
    "vs-indexes-list":                        "workspace/vectorsearchindexes/listindexes",
    "vs-indexes-get":                         "workspace/vectorsearchindexes/getindex",
    "vs-indexes-create":                      "workspace/vectorsearchindexes/createindex",
    "vs-indexes-delete":                      "workspace/vectorsearchindexes/deleteindex",
    "vs-indexes-sync":                        "workspace/vectorsearchindexes/syncindex",
    "vs-indexes-query":                       "workspace/vectorsearchindexes/queryindex",
    "vs-indexes-query-next-page":             "workspace/vectorsearchindexes/querynextpage",
    "vs-indexes-scan":                        "workspace/vectorsearchindexes/scanindex",
    "vs-indexes-upsert-data":                 "workspace/vectorsearchindexes/upsertdatavectorindex",
    "vs-indexes-delete-data":                 "workspace/vectorsearchindexes/deletedatavectorindex",
    # Workspace — AI Search
    "aisearch-endpoints-list":                "workspace/aisearch/listendpoints",
    "aisearch-endpoints-get":                 "workspace/aisearch/getendpoint",
    "aisearch-endpoints-create":              "workspace/aisearch/createendpoint",
    "aisearch-endpoints-update":              "workspace/aisearch/updateendpoint",
    "aisearch-endpoints-delete":              "workspace/aisearch/deleteendpoint",
    "aisearch-indexes-list":                  "workspace/aisearch/listindexes",
    "aisearch-indexes-get":                   "workspace/aisearch/getindex",
    "aisearch-indexes-create":                "workspace/aisearch/createindex",
    "aisearch-indexes-delete":                "workspace/aisearch/deleteindex",
    "aisearch-indexes-query":                 "workspace/aisearch/queryindex",
    "aisearch-indexes-scan":                  "workspace/aisearch/scanindex",
    "aisearch-indexes-sync":                  "workspace/aisearch/syncindex",
    "aisearch-indexes-upsert-data":           "workspace/aisearch/upsertdata",
    "aisearch-indexes-remove-data":           "workspace/aisearch/removedata",
    # Workspace — Apps
    "apps-list":                        "workspace/apps/list",
    "apps-get":                         "workspace/apps/get",
    "apps-create":                      "workspace/apps/create",
    "apps-update":                      "workspace/apps/update",
    "apps-create-update":               "workspace/apps/createupdate",
    "apps-get-update":                  "workspace/apps/getupdate",
    "apps-delete":                      "workspace/apps/delete",
    "apps-deploy":                      "workspace/apps/deploy",
    "apps-list-deployments":            "workspace/apps/getdeployments",
    "apps-get-deployment":              "workspace/apps/getdeployment",
    "apps-start":                       "workspace/apps/start",
    "apps-stop":                        "workspace/apps/stop",
    "apps-get-logs":                    "workspace/apps/getlogs",
    "apps-permission-levels":           "workspace/apps/getpermissionlevels",
    "apps-permissions-get":             "workspace/apps/getpermissions",
    "apps-permissions-set":             "workspace/apps/setpermissions",
    "apps-permissions-update":          "workspace/apps/updatepermissions",
    ...
    "scim-users-get":            "workspace/users/get",
    "scim-users-create":         "workspace/users/create",
    "scim-users-update":         "workspace/users/update",
    "scim-users-patch":          "workspace/users/patch",
    "scim-users-delete":         "workspace/users/delete",
    "scim-groups-list":          "workspace/groups/list",
    "scim-groups-get":           "workspace/groups/get",
    "scim-groups-create":        "workspace/groups/create",
    "scim-groups-update":        "workspace/groups/update",
    "scim-groups-patch":         "workspace/groups/patch",
    "scim-groups-delete":        "workspace/groups/delete",
    "scim-service-principals-list":   "workspace/serviceprincipals/list",
    "scim-service-principals-get":    "workspace/serviceprincipals/get",
    "scim-service-principals-create": "workspace/serviceprincipals/create",
    "scim-service-principals-update": "workspace/serviceprincipals/update",
    "scim-service-principals-patch":  "workspace/serviceprincipals/patch",
    "scim-service-principals-delete": "workspace/serviceprincipals/delete",
    # Workspace — Access Control
    "acc-proxy-assignable-roles":     "workspace/accountaccesscontrolproxy/getassignablerolesforresource",
    "acc-proxy-rule-set-get":         "workspace/accountaccesscontrolproxy/getruleset",
    "acc-proxy-rule-set-update":      "workspace/accountaccesscontrolproxy/updateruleset",
    "permission-migration":           "workspace/permissionmigration/migratepermissions",
    # Workspace — Tokens
    ...
    "permissions-get":             "workspace/permissions/getobjectpermissions",
    "permissions-levels-get":      "workspace/permissions/getpermissionlevels",
    "permissions-set":             "workspace/permissions/setobjectpermissions",
    "permissions-update":          "workspace/permissions/updateobjectpermissions",
    "permissions-passwords-get":         "workspace/users/getpermissions",
    "permissions-passwords-levels-get":  "workspace/users/getpermissionlevels",
    "permissions-passwords-set":         "workspace/users/setpermissions",
    "permissions-passwords-update":      "workspace/users/updatepermissions",
    ...
    "acct-workspace-assignment-list":   "account/workspaceassignment/list",
    "acct-workspace-assignment-get":    "account/workspaceassignment/get",
    "acct-workspace-assignment-update": "account/workspaceassignment/update",
    "acct-workspace-assignment-delete": "account/workspaceassignment/delete",
    # Account — Settings
